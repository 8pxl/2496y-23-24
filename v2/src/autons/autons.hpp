...
void center_far() {
  ...
  wings.toggle();
  chass.driveAngle(2700, 84.5, 780, _lin, _ang, false, 0);
  chass.driveAngle(-900, 70, 820, _lin, _ang, false, 0);
  chass.pidTurn(150, 200, _90);
  robot::intake.spin(-127);
  chass.pidTurn(150, 200, _90);
  chass.pidTurn(0, 530, _90);
  robot::intake.spin( 127);
  chass.driveAngle(2180, 0, 950, _lin, _ang, 0);
...
void barrier_far() {
  wings.toggle();
  robot::intake.spin(127);
  chass.driveAngle(3000, 80, 300, _lin, _ang);
  wings.toggle();
  chass.driveAngle(3000, 46, 1000, _lin, _ang, false, 400);
  chass.driveAngle(-200, 57, 800, _lin, _ang, false);
  ...
  chass.pidTurn(0, 530, _90);
  robot::intake.spin( 127);
  chass.driveAngle(1950, 0, 950, _lin, _ang, 0);
  chass.driveAngle(150, neg(5), 700, _lin, _angBig, false, 0);
  glb::rvert.set_value(true);
  chass.driveAngle(-1630, neg(45), 520, _lin, _ang);
  glb::rvert.set_value(false);
  ...
  chass.driveAngle(1850, 90, 700, _lin, _ang);
  ...
  robot::intake.spin(-127);
  chass.driveAngle(2400, 180, 500, _lin, _ang, false);
  chass.driveAngle(-600, 180, 400, _lin, _ang, false);
  chass.driveAngle(2400, 180, 500, _lin, _ang, false);
  chass.driveAngle(-1200, 180, 1200, _lin, _ang, false);
}
...
void safe_far() {
  ...
  chass.driveAngle(-700, 90, 500, _lin, _ang);
  chass.timedDrive(600, 127);
  chass.arcTurn(135, 7, 600, 1, _arc, 0, 0);
  chass.pidTurn(29, 500, _90);
