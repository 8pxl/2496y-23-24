...
void safe_far() {
    chass.driveAngle(-1000, neg(45), 700, _lin, _ang);
    chass.pidTurn(neg(90), 500, _90);
    chass.timedDrive(1000, -100);
    chass.driveAngle(1500, neg(45), 800, _lin, _ang);
    chass.driveAngle(2100, 0, 800, _lin, _ang);
}
...
void safe_near() {
  ...
  robot::intake.spin(127);
  chass.driveAngle(2660, neg(77), 700, _lin, _ang, false);
  chass.driveAngle(0, neg(53), 1200, _lin, _ang, false);
  chass.driveAngle(-500, 45, 500, _lin, _ang);
  glb::lvert.set_value(true);
  pros::delay(100);
  chass.pidTurn(neg(30), 400, _45);
...
lib::atns autons = {{touch_near, greedy_near, rush_far, safe_far, safe_near, greedy_far, medic, skills, far_half, no_matchload, tank},
                    {"touch_near", "greedy_near", "rush_far", "safe_far", "safe_near", "greedy_far", "medic", "skills", "far_half", "no_matchload", "tank"}};