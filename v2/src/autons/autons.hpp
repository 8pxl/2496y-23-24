...
void center_far() {
  ...
  glb::lhoriz.set_value(true);
  chass.driveAngle(2700, 78, 300, _lin, _ang, false);
  glb::lhoriz.set_value(false);
  // wings.toggle();
  chass.driveAngle(2700, 78, 740, _lin, _angBig, false, 500);
  chass.driveAngle(-30, 78, 1070, _lin, _ang, false, 0);
  ...
  robot::intake.spin( 127);
  chass.driveAngle(1700, 0, 850, _lin, _angBig, 0);
  chass.driveAngle(-100, neg(5), 650, _lin, _angBig, false, 0);
  glb::rvert.set_value(true);
  chass.driveAngle(-1270, neg(45), 430, _lin, _ang);
  chass.pidTurn(neg(100), 250, _90);
  ...
  robot::intake.spin(0);
  chass.pidTurn(120, 640, _180);
  robot::intake.spin(-127);
  glb::lhoriz.set_value(true);
  pros::delay(150);
  chass.driveAngle(3000, 100, 500, _lin, _ang);
  ...
  chass.driveAngle(1200, 24, 600, _lin, _ang);
...
void barrier_far() {
    ...
    glb::lhoriz.set_value(false);
    // wings.toggle();
    chass.driveAngle(3000, 47.8, 1000, _lin, _angBig, false, 400);
    chass.driveAngle(-100, 57, 800, _lin, _ang, false, 0);
  ...
  robot::wings.setState(false);
  chass.driveAngle(-650, 100, 300, _lin, _ang);
  chass.pidTurn(27.9, 350, _45);
  robot::intake.spin(127);
  chass.driveAngle(2810, 27.9, 1000, _lin, _ang);
  chass.driveAngle(1650, 90, 650, _lin, _ang);
  ...
  chass.driveAngle(2400, 180, 500, _lin, _ang, false);
  chass.driveAngle(-100, 180, 1200, _lin, _ang, false);
}
...
chass.driveAngle(2830, 19, 1250, _lin, _ang);
  chass.pidTurn(155, 530, _90);
  chass.driveAngle(2400, 155, 300, _lin, _ang);
  robot::intake.spin(-127);
  chass.driveAngle(3100, 180, 600, _lin, _ang, false);
  chass.driveAngle(-1800, 150, 700, _lin, _ang);
  robot::intake.spin(127);
  chass.pidTurn(65, 500, _180);
  chass.driveAngle(700, 75, 300, _lin, _ang);
  chass.driveAngle(600, 90, 400, _lin, _ang);
  // chass.driveAngle(-800, 33, 300, _lin, _ang);
  chass.pidTurn(190, 500, _90);
  robot::intake.spin(10);
  robot::wings.toggle();
  chass.driveAngle(2000, 190, 150, _lin, _ang);
  robot::intake.spin(-127);
  ...
  */
  ...
  chass.driveAngle(2400, 180, 590, _lin, _ang, false);
  robot::wings.toggle();
  chass.driveAngle(-1400, 170, 500, _lin, _ang);
  robot::intake.spin(127);
  chass.pidTurn(15, 550, _180);
  chass.driveAngle(1000, 15, 400, _lin, _ang);
  // chass.driveAngle(-800, 24, 400, _lin, _ang);
  robot::intake.spin(0);
  chass.pidTurn(170, 500, _90);
  robot::intake.spin(-127);
...
void center_near() {
    ...
    // chass.driveAngle(800, 0, 600, _lin, _ang, false);
    // chass.pidTurn(neg(57), 900, _90);
    chass.driveAngle(300, neg(70), 1500, _lin, _ang, false);
    // chass.pidTurn(54, 400, _90);
    // chass.driveAngle(-800, 54, 600, _lin, _ang);
    // chass.driveAngle(-500, 45, 500, _lin, _ang, true, -1, 0.2);
    chass.arcTurn(45, 4.1, 1200, 1, _arcSlow);
    ...
    // robot::wings.setState(true);
    // chass.driveAngle(1200, 45, 800, _lin, _ang);
    chass.driveAngle(780, 30, 900, _lin, _ang);
    chass.pidTurn(0, 500, _15);
    robot::intake.spin(-127);
    chass.driveAngle(1530, 0, 1500, _lin, _ang);
    glb::rhoriz.set_value(false);
}
