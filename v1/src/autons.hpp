...
// robot::scraper.toggle();
    ...
    robot::intake.spin(-127);
    chass.driveAngle(1360, 30, 480, _lin, _ang);
...
void rush_far() {
    ...
    chass.pidTurn(neg(139), 500, _90);
    robot::intake.spin(5);
    chass.driveAngle(2370, neg(139), 800, _lin, _ang);
...
lib::atns autons = {
    {skills, new_far, wp_near, wp_far, test2, new_near, rush_near, rush_far, no_matchload, new_skills, tank}, 
    {"skills", "new_far", "wp_near",  "wp_far", "test2", "new_near", "rush_near", "rush_far",  "no_matchload", "new_skills", "tank"}
};
